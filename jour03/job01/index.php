	...
	<main> 
		...
		<section class="row justify-content-around">
			...
			<div class="card w-50 bg-light">
			  <div class="card-body">
			    <h1 class="card-title">Bonjour, monde!</h1>
			    <p class="card-text">Il existe plusieurs visions du terme:<br/>le monde est la matière, l'espace et les phénomènes qui nous sont accessibles par les sens, l'expérience ou la raison. Le sens le plus courant désigne notre planète, la terre, avec ses habitants, et son environnement plus ou moins naturel.</p>
			    <hr>
			    <h6>Le sens étendu désigne l'univers dans son ensemble.</h6>
			...
			<div class="list-group">
				  ...
				  <button type="button" class="list-group-item list-group-item-action">Gourmandises</button>
				  ...
				  <button type="button" class="list-group-item list-group-item-action" disabled>Heresie</button>
			...
			<article class="col-4">
			    ...
			    <div class="col-auto">
			      ...
			      <div class="input-group mb-2">		        
			        ...
			        <div class="input-group-prepend">
			          <div class="input-group-text">@exemple.com</div>
			        </div>
			      </div>
			    </div>
			    ...
			    <div class="col-auto">
			      ...
			      <div class="input-group mb-2">
			        <div class="input-group-prepend">
			          <div class="input-group-text">https://l33t.lptf/dkwb/berlusconimkt/</div>
			        </div>
